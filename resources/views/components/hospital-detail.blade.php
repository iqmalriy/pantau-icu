    ...
    <div class="row">
        ...
        <div class="d-md-flex justify-content-between">
            ...
            <div class="foto d-flex justify-content-center align-items-center col-md-5 col-12">
                <div class="rounded-100"  style="background-image: url('{{$hospital->img_link??'https://lh5.googleusercontent.com/p/AF1QipOytNqnIn4abYaiTZFr9AiYaihvbo0R69xnjSTq=w408-h306-k-no'}}'); background-size:cover; height:150px; width: 150px;"></div>
            ...
            <div class="details col-md-7 col-12 mt-md-0 mt-2">
                    ...
                    <h6 class="p-medium tulisan text-md-left text-center col-8 offset-2 offset-md-0 col-md-12"><i class="fa fa-bed"></i> {{$hospital->total_bed}} Bed <span class="tulisan-kecil">(1 Jam lalu)</span> </h6>
